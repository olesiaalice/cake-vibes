...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return <Card className="overflow-hidden shadow-card hover:shadow-floating transition-all duration-300 cursor-pointer group bg-card/80 backdrop-blur-sm" onClick={handleCardClick}>
